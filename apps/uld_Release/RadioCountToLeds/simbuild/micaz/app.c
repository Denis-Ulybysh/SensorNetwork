...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b69d2e72400, const void *arg_0x2b69d2e72700);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 252
extern double erfc(double arg_0x2b69d2ef8a70) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2b69d31563a0), 
int (*key_eq_fn)(void *arg_0x2b69d3156b70, void *arg_0x2b69d3156e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b69d3357c00, int arg_0x2b69d3357e80);
static double RandomUniform(void );
...
enum SimSchedulerBasicP____nesc_unnamed4331 {
...
enum CpmModelC____nesc_unnamed4335 {
#line 528
...
#line 169
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP__0____nesc_unnamed4337 {
#line 169
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP__0____nesc_unnamed4338 {
  message_t * msg;
...
#line 43
# 55 "../../tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
static __inline void /*HplAtm128GeneralIOC.PortA.Bit0*/HplAtm128GeneralIOPinP__0__IO__set(void )
#line 55
{
  sim_log_debug(122U, "Pins", "Setting bit %i of port %i.\n", (int )0, (int )27U);
...
#line 55
{
  sim_log_debug(123U, "Pins", "Setting bit %i of port %i.\n", (int )1, (int )27U);
...
#line 55
{
  sim_log_debug(124U, "Pins", "Setting bit %i of port %i.\n", (int )2, (int )27U);
...
# 78 "../../tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x2b69d3673e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b69d3673e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x2b69d3673e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "../../tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x2b69d3672a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x2b69d3672a50, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      RadioCountToLedsC__MilliTimer__startPeriodic(1111250);
    }
  else {
...
# 110 "../../tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x2b69d3634c60, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2b69d3634c60, msg, error);
#line 110
}
#line 110
...
# 100 "../../tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2b69d3b2e940, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b69d3b2e940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2b69d3b2e940, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "../../tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b69d3492020){
#line 75
  switch (arg_0x2b69d3492020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x2b69d3492020);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "../../tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2b69d3b2db60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x2b69d3b2db60, addr, msg, len);
#line 80
...
# 83 "../../tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b69d3ddc950){
#line 83
  switch (arg_0x2b69d3ddc950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b69d3ddc950);
#line 83
      break;
#line 83
    }
...
{
  RadioCountToLedsC__Leds__led0On();
  sim_log_debug(107U, "Boot", "uld===> Application booted.\n");
  sim_log_debug(108U, "RadioCountToLedsC", "Time==> : %s\n", sim_time_string());
  RadioCountToLedsC__AMControl__start();
}
